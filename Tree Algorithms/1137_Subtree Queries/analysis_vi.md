...
Hãy xây dựng một *Euler tour* của cây. Mỗi cây con tương ứng với một
đoạn liên tiếp trong thứ tự duyệt, do đó ta có thể trả lời các truy vấn một cách hiệu quả
bằng một cây phân đoạn (segment tree).
...
### Tài liệu tham khảo về kỹ thuật Euler tour
