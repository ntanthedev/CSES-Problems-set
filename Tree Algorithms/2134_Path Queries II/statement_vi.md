...
Cho một cây gồm $n$ đỉnh. Các đỉnh được đánh số $1,2,\ldots,n$. Mỗi đỉnh có một giá trị.
...
Cuối cùng là $q$ dòng mô tả các truy vấn. Mỗi truy vấn có dạng "1 $s$ $x$" hoặc "2 $a$ $b$".
