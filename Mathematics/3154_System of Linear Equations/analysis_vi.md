...
Đoạn mã sau sử dụng phương pháp khử Gauss để giải hệ phương trình tuyến tính.
Thuật toán chạy trong $O(n^2 m)$ thời gian.
...
* [Phương pháp khử Gauss (Wikipedia)](https://en.wikipedia.org/wiki/Gaussian_elimination)
