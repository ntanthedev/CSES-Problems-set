# 2179 - Cạnh Bậc Ra Chẵn

* **Giới hạn thời gian:** 1.00 s
* **Giới hạn bộ nhớ:** 512 MB

Cho một đồ thị vô hướng, nhiệm vụ của bạn là chọn hướng cho mỗi cạnh sao cho trong đồ thị có hướng thu được, mỗi đỉnh có bậc ra chẵn. Bậc ra của một đỉnh là số cạnh đi ra từ đỉnh đó.
...
Bạn có thể giả sử đồ thị là đơn, tức là có nhiều nhất một cạnh giữa hai đỉnh bất kỳ và mọi cạnh đều nối hai đỉnh phân biệt.
