...
Cho hai cây có gốc, nhiệm vụ của bạn là xác định xem chúng có *đẳng cấu* hay không, tức là có thể vẽ chúng sao cho trông giống hệt nhau.

# Dữ liệu vào

Dòng đầu tiên chứa một số nguyên $t$: số lượng bộ test. Sau đó, có $t$ bộ test được mô tả như sau:

Dòng đầu tiên chứa một số nguyên $n$: số lượng đỉnh trong cả hai cây. Các đỉnh được đánh số $1,2,\dots,n$, và đỉnh $1$ là gốc.
